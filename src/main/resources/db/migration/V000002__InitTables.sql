...
-- 1. departments
-- department_id is SERIAL, omit from INSERT list and VALUES
...
-- position_id is SERIAL, omit from INSERT list and VALUES
INSERT INTO positions (name, department_id, min_salary, max_salary, description) VALUES
-- Отдел эксплуатации (ID будут 1, 2, 3, 4, 5)
...
-- Отдел ремонта и обслуживания (ID будут 6, 7, 8, 9)
...
-- Отдел обслуживания пассажиров (ID будут 10, 11)
...
-- Административный отдел (ID будут 13, 14)
...
-- employee_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для position_id
...
('Иван', 'Иванов', '1980-05-15', 'М', '2010-01-20', (SELECT position_id FROM positions WHERE name = 'Машинист локомотива'), 95000.00, 2, TRUE), -- Будет employee_id = 1
('Петр', 'Петров', '1985-11-22', 'М', '2012-03-10', (SELECT position_id FROM positions WHERE name = 'Помощник машиниста'), 60000.00, 1, TRUE), -- Будет employee_id = 2
('Сидор', 'Сидоров', '1978-07-30', 'М', '2008-06-01', (SELECT position_id FROM positions WHERE name = 'Машинист локомотива'), 105000.00, 0, TRUE), -- Будет employee_id = 3
('Анна', 'Диспетчерова', '1990-04-18', 'Ж', '2016-11-11', (SELECT position_id FROM positions WHERE name = 'Dиспетчер движения поездов'), 75000.00, 0, TRUE), -- Будет employee_id = 4
('Сергей', 'Осмотров', '1987-09-05', 'М', '2014-08-08', (SELECT position_id FROM positions WHERE name = 'Осмотрщик вагонов'), 50000.00, 1, TRUE), -- Будет employee_id = 5
('Олег', 'Составителев', '1992-12-01', 'М', '2020-07-15', (SELECT position_id FROM positions WHERE name = 'Составитель поездов'), 55000.00, 0, TRUE), -- Будет employee_id = 6
('Николай', 'Локомотивин', '1983-06-18', 'М', '2011-05-03', (SELECT position_id FROM positions WHERE name = 'Машинист локомотива'), 80000.00, 1, TRUE), -- Будет employee_id = 7 (Не годен - для примера)
('Дмитрий', 'Ремонтников', '1975-03-10', 'М', '2005-09-01', (SELECT position_id FROM positions WHERE name = 'Начальник ремонтной бригады'), 90000.00, 3, TRUE), -- Будет employee_id = 8
('Елена', 'Техникова', '1988-09-05', 'Ж', '2018-04-11', (SELECT position_id FROM positions WHERE name = 'Техник по ремонту локомотивов'), 65000.00, 0, TRUE), -- Будет employee_id = 9
('Мария', 'Вагонова', '1991-01-25', 'Ж', '2017-05-03', (SELECT position_id FROM positions WHERE name = 'Техник по ремонту вагонов'), 62000.00, 0, TRUE), -- Будет employee_id = 10
('Игорь', 'Путейцев', '1989-11-29', 'М', '2019-03-21', (SELECT position_id FROM positions WHERE name = 'Монтер пути'), 55000.00, 0, TRUE), -- Будет employee_id = 11
('Ольга', 'Кассирова', '1995-02-28', 'Ж', '2021-11-20', (SELECT position_id FROM positions WHERE name = 'Кассир билетный'), 45000.00, 0, TRUE), -- Будет employee_id = 12
('Алексей', 'Справочников', '1998-08-12', 'М', '2022-09-15', (SELECT position_id FROM positions WHERE name = 'Агент справочной службы'), 40000.00, 0, TRUE), -- Будет employee_id = 13
('Светлана', 'Кадровикова', '1982-06-07', 'Ж', '2013-02-14', (SELECT position_id FROM positions WHERE name = 'Специалист по кадрам'), 55000.00, 2, TRUE), -- Будет employee_id = 14
('Андрей', 'Бухгалтеров', '1970-10-04', 'М', '2000-12-01', (SELECT position_id FROM positions WHERE name = 'Бухгалтер'), 75000.00, 1, TRUE); -- Будет employee_id = 15


-- 4. medical_examinations (Зависит от employees)
-- examination_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для employee_id
...
-- 5. brigades (Зависит от departments, employees)
-- brigade_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для department_id и manager_id
...
-- 6. employee_brigade (Зависит от employees, brigades)
-- No SERIAL PK, columns match values
-- Используем подзапросы для employee_id и brigade_id
...
-- 7. train_types
-- type_id is SERIAL, omit from INSERT list and VALUES
...
-- 8. stations
-- station_id is SERIAL, omit from INSERT list and VALUES
INSERT INTO stations (name, address, region) VALUES
('Москва Павелецкая', 'Павелецкая площадь, 1А', 'Москва'), -- Будет station_id = 1
('Санкт-Петербург Московский', 'Невский проспект, 85', 'Санкт-Петербург'), -- Будет station_id = 2
('Нижний Новгород Московский', 'площадь Революции, 2', 'Нижегородская область'), -- Будет station_id = 3
('Казань Пассажирская', 'Привокзальная площадь, 1', 'Республика Татарстан'), -- Будет station_id = 4
('Сочи', 'улица Горького, 56А', 'Краснодарский край'), -- Будет station_id = 5
('Владимир', 'Вокзальная площадь, 2', 'Владимирская область'); -- Будет station_id = 6


-- 9. route_categories
-- category_id is SERIAL, omit from INSERT list and VALUES
INSERT INTO route_categories (name) VALUES
('внутренний'), -- Будет category_id = 1
('международный'),
('туристический'),
('специальный'),
('пригородный'); -- Будет category_id = 5


-- 10. trains
-- train_id is SERIAL, omit from INSERT list and VALUES
INSERT INTO trains (model, build_date, last_maintenance_date, status) VALUES
('ЭП20', '2012-05-10', '2023-10-05', 'в порядке'),      -- Будет train_id = 1 (Скоростной локомотив)
('ЧС7', '1985-01-20', '2023-09-15', 'в порядке'),      -- Будет train_id = 2 (Пассажирский локомотив)
('2ТЭ116У', '2010-08-01', '2023-09-20', 'в порядке'),   -- Будет train_id = 3 (Грузовой локомотив)
('Ласточка', '2014-03-18', '2023-10-10', 'в ремонте'),  -- Будет train_id = 4 (Моторвагонный поезд (сидячий))
('ЭР2', '1975-01-01', '2023-11-01', 'требует ремонта'); -- Будет train_id = 5 (Пригородный поезд)


-- 11. routes (Зависит от stations, route_categories)
-- route_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для station_id и category_id
INSERT INTO routes (name, start_station, end_station, distance_km, category_id) VALUES
('Москва - Санкт-Петербург', (SELECT station_id FROM stations WHERE name = 'Москва Павелецкая'), (SELECT station_id FROM stations WHERE name = 'Санкт-Петербург Московский'), 700, (SELECT category_id FROM route_categories WHERE name = 'внутренний')), -- Будет route_id = 1
('Москва - Нижний Новгород', (SELECT station_id FROM stations WHERE name = 'Москва Павелецкая'), (SELECT station_id FROM stations WHERE name = 'Нижний Новгород Московский'), 400, (SELECT category_id FROM route_categories WHERE name = 'внутренний')), -- Будет route_id = 2
('Санкт-Петербург - Сочи', (SELECT station_id FROM stations WHERE name = 'Санкт-Петербург Московский'), (SELECT station_id FROM stations WHERE name = 'Сочи'), 2500, (SELECT category_id FROM route_categories WHERE name = 'внутренний')), -- Будет route_id = 3
('Москва - Владимир (Пригородный)', (SELECT station_id FROM stations WHERE name = 'Москва Павелецкая'), (SELECT station_id FROM stations WHERE name = 'Владимир'), 180, (SELECT category_id FROM route_categories WHERE name = 'пригородный')); -- Будет route_id = 4


-- 12. route_stops (Зависит от routes, stations)
-- route_stop_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для route_id и station_id
...
-- 13. schedules (Зависит от trains, train_types, routes)
-- schedule_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для train_id, type_id, route_id
INSERT INTO schedules (train_id, train_number, type_id, train_status, route_id, departure_time, arrival_time, base_price) VALUES
((SELECT train_id FROM trains WHERE model = 'ЭП20'), '758А', (SELECT type_id FROM train_types WHERE name = 'скорый'), 'по расписанию', (SELECT route_id FROM routes WHERE name = 'Москва - Санкт-Петербург'), '2023-11-25 14:00:00', '2023-11-25 22:00:00', 3000.00), -- Будет schedule_id = 1
((SELECT train_id FROM trains WHERE model = 'ЧС7'), '001М', (SELECT type_id FROM train_types WHERE name = 'пассажирский'), 'по расписанию', (SELECT route_id FROM routes WHERE name = 'Москва - Санкт-Петербург'), '2023-11-25 23:00:00', '2023-11-26 07:30:00', 2500.00), -- Будет schedule_id = 2
((SELECT train_id FROM trains WHERE model = 'ЧС7'), '002Я', (SELECT type_id FROM train_types WHERE name = 'пассажирский'), 'по расписанию', (SELECT route_id FROM routes WHERE name = 'Москва - Нижний Новгород'), '2023-11-26 08:00:00', '2023-11-26 12:00:00', 1500.00), -- Будет schedule_id = 3
((SELECT train_id FROM trains WHERE model = '2ТЭ116У'), '999Ч', (SELECT type_id FROM train_types WHERE name = 'грузовой'), 'в пути', (SELECT route_id FROM routes WHERE name = 'Санкт-Петербург - Сочи'), '2023-11-24 10:00:00', '2023-11-26 02:00:00', 5000.00), -- Будет schedule_id = 4
((SELECT train_id FROM trains WHERE model = 'ЭР2'), '6616', (SELECT type_id FROM train_types WHERE name = 'пассажирский'), 'по расписанию', (SELECT route_id FROM routes WHERE name = 'Москва - Владимир (Пригородный)'), '2023-11-25 18:30:00', '2023-11-25 20:20:00', 400.00); -- Будет schedule_id = 5


-- 14. train_crews (Зависит от schedules, brigades)
-- crew_assignment_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для schedule_id и brigade_id
...
-- 15. maintenance (Зависит от trains, brigades)
-- maintenance_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для train_id и brigade_id
...
-- 16. passengers
-- passenger_id is SERIAL, omit from INSERT list and VALUES
...
('Александр', 'Петров', 'Иванович', '1993-04-01', 'М', '1234', '567890', '89011234567', 'alex.petrov@example.com'), -- Будет passenger_id = 1
('Екатерина', 'Иванова', 'Сергеевна', '1990-08-10', 'Ж', '5678', '123456', '89029876543', 'e.ivanova@example.com'), -- Будет passenger_id = 2
('Николай', 'Смирнов', NULL, '2005-11-25', 'М', '9012', '345678', NULL, NULL), -- Будет passenger_id = 3 (Без отчества и контактов, может быть ребенок)
('Ольга', 'Кузнецова', 'Алексеевна', '1985-01-15', 'Ж', '3456', '789012', '89037654321', 'o.kuznecova@example.com'); -- Будет passenger_id = 4

-- 17. luggage (Зависит от passengers)
-- luggage_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для passenger_id
...
-- Будут luggage_id 1, 2, 3

-- 18. cars (Зависит от trains)
-- car_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для train_id (может быть NULL)
INSERT INTO cars (car_number, train_id, car_type, capacity, build_date, status) VALUES
('001П', (SELECT train_id FROM trains WHERE model = 'ЭП20'), 'плацкарт', 54, '2008-07-01', 'в эксплуатации'), -- Будет car_id = 1 (Для поезда ЭП20)
('002П', (SELECT train_id FROM trains WHERE model = 'ЭП20'), 'плацкарт', 54, '2008-07-01', 'в эксплуатации'), -- Будет car_id = 2 (Для поезда ЭП20)
('003К', (SELECT train_id FROM trains WHERE model = 'ЭП20'), 'купе', 36, '2015-09-10', 'в эксплуатации'),   -- Будет car_id = 3 (Для поезда ЭП20)
('004С', (SELECT train_id FROM trains WHERE model = 'ЧС7'), 'сидячий', 62, '2012-04-05', 'в эксплуатации'),   -- Будет car_id = 4 (Для поезда ЧС7)
('005С', (SELECT train_id FROM trains WHERE model = 'ЧС7'), 'сидячий', 62, '2012-04-05', 'в эксплуатации'),   -- Будет car_id = 5 (Для поезда ЧС7)
('006С', (SELECT train_id FROM trains WHERE model = 'ЧС7'), 'сидячий', 62, '2012-04-05', 'в ремонте'),     -- Будет car_id = 6 (Для поезда ЧС7)
('007Р', (SELECT train_id FROM trains WHERE model = 'ЭП20'), 'ресторан', 30, '2010-11-20', 'в эксплуатации'),  -- Будет car_id = 7 (Для поезда ЭП20)
('008Б', (SELECT train_id FROM trains WHERE model = '2ТЭ116У'), 'багажный', 0, '1998-02-14', 'в эксплуатации'),  -- Будет car_id = 8 (Для поезда 2ТЭ116У - грузовой)
('П01', (SELECT train_id FROM trains WHERE model = 'ЭР2'), 'сидячий', 100, '1975-01-01', 'в эксплуатации');  -- Будет car_id = 9 (Для поезда ЭР2 - пригородный)


-- 19. seats (Зависит от cars)
-- seat_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для car_id
-- Плацкарт 001П (car_id=1)
INSERT INTO seats (car_id, seat_number, seat_type, is_available, features) VALUES
((SELECT car_id FROM cars WHERE car_number = '001П'), '1', 'нижнее', TRUE, 'У окна, рядом розетка'), -- Будет seat_id=1
((SELECT car_id FROM cars WHERE car_number = '001П'), '2', 'верхнее', TRUE, 'У прохода'), -- Будет seat_id=2
((SELECT car_id FROM cars WHERE car_number = '001П'), '3', 'нижнее', TRUE, 'У окна'), -- Будет seat_id=3
((SELECT car_id FROM cars WHERE car_number = '001П'), '4', 'верхнее', TRUE, 'У прохода'), -- Будет seat_id=4
((SELECT car_id FROM cars WHERE car_number = '001П'), '37', 'боковое нижнее', TRUE, NULL), -- Будет seat_id=5 (Боковые места)
((SELECT car_id FROM cars WHERE car_number = '001П'), '38', 'боковое верхнее', TRUE, NULL); -- Будет seat_id=6

-- Купе 003К (car_id=3)
INSERT INTO seats (car_id, seat_number, seat_type, is_available, features) VALUES
((SELECT car_id FROM cars WHERE car_number = '003К'), '1', 'нижнее', TRUE, NULL), -- Будет seat_id=7
((SELECT car_id FROM cars WHERE car_number = '003К'), '2', 'верхнее', TRUE, NULL), -- Будет seat_id=8
((SELECT car_id FROM cars WHERE car_number = '003К'), '3', 'нижнее', TRUE, NULL), -- Будет seat_id=9
((SELECT car_id FROM cars WHERE car_number = '003К'), '4', 'верхнее', FALSE, 'Неисправна полка'); -- Будет seat_id=10 (Одно место не доступно)

-- Сидячий 004С (car_id=4)
INSERT INTO seats (car_id, seat_number, seat_type, is_available, features) VALUES
((SELECT car_id FROM cars WHERE car_number = '004С'), '5A', 'у окна', TRUE, 'Розетка'), -- Будет seat_id=11
((SELECT car_id FROM cars WHERE car_number = '004С'), '5B', 'у прохода', TRUE, NULL), -- Будет seat_id=12
((SELECT car_id FROM cars WHERE car_number = '004С'), '6A', 'у окна', TRUE, NULL); -- Будет seat_id=13

-- Сидячий П01 (car_id=9) - Пригородный
INSERT INTO seats (car_id, seat_number, seat_type, is_available, features) VALUES
((SELECT car_id FROM cars WHERE car_number = 'П01'), '1', 'у окна', TRUE, NULL), -- Будет seat_id=14
((SELECT car_id FROM cars WHERE car_number = 'П01'), '2', 'у прохода', TRUE, NULL), -- Будет seat_id=15
((SELECT car_id FROM cars WHERE car_number = 'П01'), '3', 'у окна', TRUE, NULL), -- Будет seat_id=16
((SELECT car_id FROM cars WHERE car_number = 'П01'), '4', 'у прохода', TRUE, NULL); -- Будет seat_id=17


-- 20. tickets (Зависит от schedules, passengers, cars, seats, luggage)
-- ticket_id is SERIAL, omit from INSERT list and VALUES
-- Используем подзапросы для schedule_id, passenger_id, car_id, seat_id, luggage_id
INSERT INTO tickets (schedule_id, passenger_id, seat_id, luggage_id, purchase_date, price, ticket_status) VALUES
-- Билет на рейс 758А (schedule_id=1), плацкарт 001П (car_id=1), место 1 (seat_id=1)
((SELECT schedule_id FROM schedules WHERE train_number = '758А' AND departure_time = '2023-11-25 14:00:00'),
 ...
 1,
 '2023-11-20 10:00:00', 3500.00, 'оплачен'), -- Будет ticket_id = 1

-- Билет на рейс 758А (schedule_id=1), плацкарт 001П (car_id=1), место 37 (seat_id=5)
((SELECT schedule_id FROM schedules WHERE train_number = '758А' AND departure_time = '2023-11-25 14:00:00'),
 ...
 2,
 '2023-11-21 11:00:00', 3200.00, 'оплачен'), -- Будет ticket_id = 2

-- Билет на рейс 001М (schedule_id=2), купе 003К (car_id=3), место 1 (seat_id=7)
((SELECT schedule_id FROM schedules WHERE train_number = '001М' AND departure_time = '2023-11-25 23:00:00'),
 ...
 3,
 '2023-11-22 12:00:00', 4000.00, 'оплачен'), -- Будет ticket_id = 3

-- Билет на рейс 002Я (schedule_id=3), сидячий 004С (car_id=4), место 5A (seat_id=11)
((SELECT schedule_id FROM schedules WHERE train_number = '002Я' AND departure_time = '2023-11-26 08:00:00'),
 ...
 NULL, -- Без багажа
 '2023-11-23 15:00:00', 1800.00, 'забронирован'), -- Будет ticket_id = 4

-- Билет на рейс 758А (schedule_id=1), купе 003К (car_id=3), место 3 (seat_id=9)
((SELECT schedule_id FROM schedules WHERE train_number = '758А' AND departure_time = '2023-11-25 14:00:00'),
 ...
 NULL, -- Без багажа
 '2023-11-24 18:00:00', 4500.00, 'возвращен'), -- Будет ticket_id = 5

-- Билет на пригородный рейс 6616 (schedule_id=5), сидячий П01 (car_id=9), место 2 (seat_id=15)
((SELECT schedule_id FROM schedules WHERE train_number = '6616' AND departure_time = '2023-11-25 18:30:00'),
 ...
 NULL, -- Без багажа
 '2023-11-25 10:00:00', 400.00, 'оплачен'); -- Будет ticket_id = 6